...
# after it.
FAST_STAGES := render negative promtool shell-syntax pvc-retention runtime-templates duplicate-names reclaimer secret-contract secrets-encrypted values-consumers
...
secrets-encrypted:
	@scripts/ci/secrets-encrypted.sh
