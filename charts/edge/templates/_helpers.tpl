...
{{- define "edge.validate" -}}
  ...
  {{- /* TWO ENGINES, ONE JOB. Running both means the Lua hook strips each
         ...
         reverses to nothing. */ -}}
  {{- if and (eq (include "edge.deidEngine" .) "orthanc") (eq (include "edge.deidEngine" .) "ingest") }}
